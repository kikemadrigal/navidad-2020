...
SONG:
	incbin "src\song_sin_cabecera.pt3"			;musica de ejemplo
	;incbin "src\musica_sin_cabacera.pt3"			;musica de ejemplo
    ;incbin "src\prueba.pt3"
    ;incbin "src\prueba_sin_cabecera.pt3"
contador: db 0
