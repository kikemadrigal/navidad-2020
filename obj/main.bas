...
90 'We define the tiles by directly drawing the tiles on page 1-Definimos los tiles dibujando directamente los pizeles en la página 1'
100 gosub 10000
...
1 'Snowflake initialization-Inicialización copos de nieve'
...
20000' Rutina pintar tiles en página 0
    ...
    1 'Definición del mapa de tiles'
    ...
    1 '21011 DATA 14,14,12,12,12,12,12,12,12,12,12,12,12,12,14,14
    21011 DATA 15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15
    1 '21012 DATA 14,14,14,14,14,14,14,14,14,14,14,14,14,14,14,14
    21012 DATA 15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15
    1 'Pintamos el tropnco para practicar con draw y lo rellenamos de marrón'
...
1 ' Metiendo el copo de nieve en la RAM'
    22000 RESTORE 22100
    22010 FOR G=0 TO 1
        22020 FOR I=0 TO 15
        22030 READ S$(G)
